...
class NetworkVideoPlayerCinema extends StatefulWidget {
  ...
  @override
  State<NetworkVideoPlayerCinema> createState() =>
      _NetworkVideoPlayerCinemaState();
}
  ...
  void initState() {
    _flickManager = FlickManager(
      videoPlayerController: VideoPlayerController.network(
          "https://media.istockphoto.com/id/472702505/video/premiere-after-showing-1.mp4?s=mp4-640x640-is&k=20&c=g_JlMCaQBnew4bLLF_hv5gmPC3Mx4RHv5A1PnZ9S8SA="),
    );
    super.initState();
  }
